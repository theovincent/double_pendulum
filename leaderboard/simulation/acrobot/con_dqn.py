...
p = json.load(
    open(f"../../../src/python/experiments/acrobot/figures/{experiment_name}/parameters.json")
)  # p for parameters
controller = DQNController(
    f"../../../src/python/experiments/acrobot/figures/{experiment_name}/DQN/Q_10_{best_params}_best_online_params",
    p["n_actions"],
    p["layers_dimensions"]
)
